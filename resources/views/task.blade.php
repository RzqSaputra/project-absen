                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('task.simpanTask'); }}" method="POST">
                                @csrf
                                <div class="mb-3">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="px-2 mb-0 text-xs">{{$task->firstItem()+$key}}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{$t->selesaiTask}}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{$t->keterangan}}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                ...
                                                <form action="/task/update/{{ $t->id }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="mulaiTask" id="mulaiTask"
                                                            value="{{ old('mulaiTask') ?? $t->mulaiTask }}"
                                                            class="form-control @error('mulaiTask') is-invalid @enderror">
                                                        @error('mulaiTask')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" name="selesaiTask" id="selesaiTask"
                                                            value="{{ old('selesaiTask') ?? $t->selesaiTask }}"
                                                            class="form-control @error('selesaiTask') is-invalid @enderror">
                                                        @error('selesaiTask')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                ...
                                <div class="modal fade" id="deleteModal-{{ $t->id }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content" style="padding: 15px">
                                            <div class="modal-body">Hapus data {{$t->nama }} ?</div>
                                            <div style="margin-right: 10px;">
                                                <a class="btn btn-danger" href="/task/delete/{{$t->id}}"
